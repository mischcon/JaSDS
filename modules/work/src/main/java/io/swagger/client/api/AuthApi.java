...
import io.swagger.client.model.AuthInitResources;
...
import io.swagger.client.model.ResetPasswordWithTokenRequest;
import io.swagger.client.model.ResetPasswordTokenValidateResponse;
...
public class AuthApi {
   ...
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt;&lt;br/&gt;Request an email with a request token for a certain user to reset his/her password.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; Registered user account.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; Provided user receives email with reset token.&lt;/p&gt;&lt;/div&gt;&lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Currently supported languages (with ISO 639-1 code):&lt;/strong&gt;&lt;br&gt;&lt;/p&gt;&lt;ul&gt;&lt;li&gt;German (de)&lt;/li&gt;&lt;li&gt;English (en)&lt;/li&gt;&lt;li&gt;Spanish (es)&lt;/li&gt;&lt;li&gt;Turkish (tr)&lt;/li&gt;&lt;/ul&gt;&lt;/div&gt;
   * @param body  (required)
   * @throws ApiException if fails to make API call
   */
  ...
  /**
   * Reset password
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt;&lt;br/&gt;Resets a user&#39;s password to a new value.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; User received a password reset token.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; Newly transmitted password is set.&lt;/p&gt;&lt;/div&gt;
   ...
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt;&lt;br/&gt;Request all information for a password change dialogue (e.g. real name of user).&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; User received a password reset token.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; None.&lt;/p&gt;&lt;/div&gt;
   * @param token Password reset token (required)
