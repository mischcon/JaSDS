...
import io.swagger.client.model.NewCustomerResponse;
import io.swagger.client.model.NewCustomerRequest;
import io.swagger.client.model.UpdateCustomerResponse;
...
public class ProvisioningApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Customer getCustomer(String xSdsServiceToken, Long customerId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public UserList getCustomerUsers(String xSdsServiceToken, Long customerId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public CustomerList getCustomers(String xSdsServiceToken, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
  ...
  /**
   * Create customer
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br /&gt;Create a new customer.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; none.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; A new customer is created.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Further Information:&lt;/strong&gt; Authentication with &lt;b&gt;X-Sds-Auth-Token&lt;/b&gt; required. If no company name is set, F.NAME of the first DSA is used. Max quota has to be at least 1 GB (&#x3D; 1073741824).&lt;/p&gt;&lt;/div&gt;
   * @param xSdsServiceToken Service Authentication token (required)
   * @param body  (required)
   * @return NewCustomerResponse
   * @throws ApiException if fails to make API call
   */
  public NewCustomerResponse newCustomerRequest(String xSdsServiceToken, NewCustomerRequest body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public UpdateCustomerResponse updateCustomer(String xSdsServiceToken, Long customerId, UpdateCustomerRequest body) throws ApiException {
    Object localVarPostBody = body;
