...
import io.swagger.client.model.CreateDownloadShareRequest;
import io.swagger.client.model.UploadShare;
import io.swagger.client.model.CreateUploadShareRequest;
import io.swagger.client.model.DownloadShareList;
import io.swagger.client.model.UploadShareList;
...
public class SharesApi {
   ...
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br/&gt;Create a new Download Share.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; Share permission on target node.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; Download Share created.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Further Information:&lt;/strong&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Access password:&lt;/b&gt; Passwords are limited to 150 characters.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Notes:&lt;/b&gt; Notes are limited to 255 characters.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Alias Names:&lt;/b&gt; Alias names are limited to 150 characters.&lt;/li&gt;&lt;li&gt;&lt;div&gt;&lt;b&gt;Send Mail:&lt;/b&gt; Following fields are optional, if &lt;dfn&gt;&amp;lt;sendMail&amp;gt;&lt;/dfn&gt; is set to false: &lt;dfn&gt;&amp;lt;mailRecipients&amp;gt; &amp;lt;mailSubject&amp;gt; &amp;lt;mailBody&amp;gt;&lt;/dfn&gt;.&lt;br/&gt;If &lt;dfn&gt;&amp;lt;sendMail&amp;gt;&lt;/dfn&gt; is set to true, these fields are mandatory fields:  &lt;dfn&gt;&amp;lt;mailRecipients&amp;gt; &amp;lt;mailBody&amp;gt;&lt;/dfn&gt;.&lt;/div&gt;&lt;/li&gt;&lt;/ul&gt;&lt;/p&gt;&lt;/div&gt;
   * @param xSdsAuthToken Authentication token (required)
   * @param body  (required)
   * @return DownloadShare
   * @throws ApiException if fails to make API call
   */
  public DownloadShare createDownloadShare(String xSdsAuthToken, CreateDownloadShareRequest body) throws ApiException {
   ...
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br/&gt;Create a new Upload Share (aka Upload Account).&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; Share permission on target container.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; Upload Share is created.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Further Information:&lt;/strong&gt;&lt;ul&gt;&lt;li&gt;&lt;b&gt;Notes:&lt;/b&gt; Notes are limited to 255 characters.&lt;/li&gt;&lt;li&gt;&lt;b&gt;Alias Names:&lt;/b&gt; Alias names are limited to 150 characters.&lt;/li&gt;&lt;li&gt;&lt;div&gt;&lt;b&gt;Send Mail:&lt;/b&gt; Following fields are optional, if &lt;dfn&gt;&amp;lt;sendMail&amp;gt;&lt;/dfn&gt; is set to false: &lt;dfn&gt;&amp;lt;mailRecipients&amp;gt; &amp;lt;mailSubject&amp;gt; &amp;lt;mailBody&amp;gt;&lt;/dfn&gt;.&lt;br/&gt;If &lt;dfn&gt;&amp;lt;sendMail&amp;gt;&lt;/dfn&gt; is set to true, these fields are mandatory fields:  &lt;dfn&gt;&amp;lt;mailRecipients&amp;gt; &amp;lt;mailSubject&amp;gt; &amp;lt;mailBody&amp;gt;&lt;/dfn&gt;.&lt;/div&gt;&lt;/li&gt;&lt;/ul&gt;&lt;/p&gt;&lt;/div&gt;
   * @param xSdsAuthToken Authentication token (required)
   * @param body  (required)
   * @return UploadShare
   * @throws ApiException if fails to make API call
   */
  public UploadShare createUploadShare(String xSdsAuthToken, CreateUploadShareRequest body) throws ApiException {
    Object localVarPostBody = body;
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteUploadShare(String xSdsAuthToken, Integer shareId) throws ApiException {
    Object localVarPostBody = null;
  ...
  /**
   * Get download share
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br/&gt;Retrieve detailed information about one Download Share.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; None.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; None.&lt;/p&gt;&lt;/div&gt;
   * @param xSdsAuthToken Authentication token (required)
   * @param shareId Share Id (required)
   * @return DownloadShare
   * @throws ApiException if fails to make API call
   */
  public DownloadShare getDownloadShare(String xSdsAuthToken, Long shareId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public DownloadShareList getDownloadShares(String xSdsAuthToken, Long userId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
  ...
  /**
   * Get upload share
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br/&gt;Retrieve detailed information about one Upload Share (aka Upload Account).&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; None.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; None.&lt;/p&gt;&lt;/div&gt;
   * @param xSdsAuthToken Authentication token (required)
   * @param shareId Share Id (required)
   * @return UploadShare
   * @throws ApiException if fails to make API call
   */
  public UploadShare getUploadShare(String xSdsAuthToken, Integer shareId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public UploadShareList getUploadShares(String xSdsAuthToken, Long userId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
